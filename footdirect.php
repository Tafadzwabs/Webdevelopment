...
<head>
    ...
    <title>About Us | Canteen ordering system </title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">Benedict</h4>
            <p class="mt-2 mb-3 fw-normal h6 "></p>
            <p class="mb-3 fw-bold text-bold text-wrap">Canteen ordering system</p>
            <h4 class="mt-2 mb-3 fw-normal "></h4><p class="mt-2 mb-3 fw-normal h6 ">Department Of Technology</p>
