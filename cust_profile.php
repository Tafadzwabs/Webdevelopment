...
<?php include('nav_header.php')?>
    ...
    <div class="container px-5 py-4" id="cart-body">
        ...
        <?php
            ...
            $query = "SELECT c_username,c_firstname,c_lastname,c_email,c_gender,c_type,std_number FROM customer WHERE c_id = {$_SESSION['cid']} LIMIT 0,1";
        ...
        <div class="row row-cols-1 mt-4">
            <dl class="row">
                ...
                <?php
                if($row['c_username'] != 'admin')
                {
                ?>

                <dt class="col-sm-3">student number</dt>
                <dd class="col-sm-9"><?php echo $row["std_number"];?></dd>
